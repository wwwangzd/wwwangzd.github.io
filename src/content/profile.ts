    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          专业成绩：前六学期综合学分绩点 3.92 / 4.00，绩点排名 4 / 145 (前3%)，综合成绩排名 2 / 145 (前2%)。

          荣誉情况：本科生国家奖学金，厦门大学优秀三好学生，厦门大学通报表扬，厦门大学优秀毕业生。
      ...
      items: [
        {
          ...
          1. 负责 Agent 托管平台稳定性建设，分别包括 Agent 侧和平台侧的全闭环观测监控，提供可观测性指标看板与报警监控治理。
        ...
        },
        {
          ...
          body: `建设维护 DPT (Douyin Privacy & Trust) 平台，配合监管合规团队，实现抖音隐私合规相关风险的预防、发现和治理全链路解决方案：

          1. 响应监管合规团队，维护和升级部门 DPT 平台目前现有服务，包括埋点数据上报、处理和展示。

          2. 负责 DPT-PIA 隐私风险评估平台研发，实现对涉及用户数据的敏感行为风险的上报、评估和管理全流程（技术栈包括 Go + Hertz + KiteX + MySQL + ElasticSearch）。
          `,
        },
      ],
    },
